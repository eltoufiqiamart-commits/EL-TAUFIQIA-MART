...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  const navLinks = [
    ...
    { href: "/admin/vehicles", label: "السيارات", icon: "vehicles" },
  ];
            ...
            {navLinks.map(link => (
              <li key={link.href}>
                ...
                >
                  ...
                  {link.icon === "vehicles" && (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 17h14l1-5-2-4H6l-2 4 1 5Zm0 0v2m14-2v2M7 12h10M8 8l1-2h6l1 2" /></svg>
                  )}
