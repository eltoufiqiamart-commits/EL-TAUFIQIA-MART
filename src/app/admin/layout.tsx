            ...
            {navLinks.map(link => (
              <li key={link.href}>
                ...
                >
                  ...
                  {link.icon === "products" && (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7.5 12 3 4 7.5m16 0L12 12 4 7.5M20 7.5V16.5L12 21 4 16.5V7.5M12 12v9" />
                    </svg>
                  )}
                  {link.icon === "brands" && (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3l2.6 5.27 5.82.85-4.21 4.1.99 5.79L12 16.27l-5.2 2.74.99-5.79-4.21-4.1 5.82-.85L12 3z" />
                    </svg>
                  )}
